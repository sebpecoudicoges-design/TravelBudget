...
function ensureStateIntegrity() {
  ...
  if (state.budgetSegments.length === 0) {
    state.budgetSegments = [{
      ...
      transportNightBudget: null,
      transport_night_budget: null,
      fxMode: "fixed",
  ...
  state.budgetSegments = state.budgetSegments
    ...
    .map((seg, idx) => ({
      ...
      transportNightBudget: _safeNumber(seg.transportNightBudget ?? seg.transport_night_budget ?? seg.night_transport_budget, null),
      transport_night_budget: _safeNumber(seg.transportNightBudget ?? seg.transport_night_budget ?? seg.night_transport_budget, null),
