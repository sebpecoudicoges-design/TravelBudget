  ...
  if(host){
    ...
    if(!segs.length){
      ...
      segs.forEach((seg, idx)=>{
        ...
        if (editBtn) editBtn.onclick = ()=>{ wrap.classList.add('is-editing'); wrap.classList.remove('is-collapsed'); try{ wrap.scrollIntoView({behavior:'smooth', block:'start'});}catch(_){} };
