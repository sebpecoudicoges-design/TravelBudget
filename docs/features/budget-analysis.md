...
- La carte `Budget net vs projection` expose le montant des entrées budget déduites afin que le numérateur net ne soit pas confondu avec les seules dépenses brutes.
