...
- [ ] Faire executer le retest ajout/favoris Alimentation `10.5.338` en clair/sombre, 1440/390 px et Android, avec changement de module pendant la synchronisation.
