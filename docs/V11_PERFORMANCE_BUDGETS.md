...
- Bundle Vite JS lazy : 421 KiB maximum.
- Bundle Vite JS total : 679 KiB maximum.
...
En 10.5.334, Sport corrige la colonne de progression demandee au premier chargement et compacte l historique apres les sept seances recentes. Le parametre mort `sessionId` du renderer de contenu est retire pour absorber le nouveau contrat visuel sans relever les plafonds. Sport mesure 440.0 / 450 KiB, l initial 257.4 / 260 KiB, le lazy 420.0 / 420 KiB, le total JS 677.5 / 678 KiB et le CSS 39.0 / 39 KiB.
...
En 10.5.350, Abonnements ajoute le suivi manuel, l analyse par abonnement et le rattachement Transactions en masse. Le domaine mesure 62.0 / 63 KiB; l initial reste stable a 262.1 / 263 KiB. Les deux vues lazy passent a 437.9 / 439 KiB, le total JS a 699.9 / 701 KiB et le CSS a 51.8 / 52 KiB. Les plafonds suivent les paliers mesures avec moins de 1.2 KiB de marge, sans relever le boot ni le gzip principal.
...
En 10.5.353, le resume Abonnements empile les devises et redistribue ses indicateurs sans ajouter de dependance. Le domaine reste sous son plafond a 67.8 / 69 KiB, l initial a 262.1 / 263 KiB, le lazy a 441.2 / 442 KiB et le total JS a 703.3 / 704 KiB. Le CSS atteint 55.7 / 56 KiB et le gzip principal reste a 74.8 / 110 KiB; aucun plafond n est releve.

En 10.5.354, la file d associations explicables, la detection locale de doublons, la fiche abonnement et leurs contrats responsives portent le domaine Abonnements a 80.5 / 82 KiB. Le chargement initial reste stable a 262.1 / 263 KiB; les modules charges a la demande atteignent 448.8 / 450 KiB et le total 710.9 / 712 KiB. Le CSS passe a 58.7 / 59 KiB pour les cartes, la fiche et la grille d onglets mobile. Les plafonds sont resserres autour de ces mesures, sans relever le gzip principal de 74.8 / 110 KiB.
...
En 10.5.355, la ventilation tresorerie par sous-categorie et l imputation des avoirs quittent le groupe Analyse historique pour le sous-module dedie `analysisCashBreakdown.js`, budgete a 8 KiB. Le plafond Analyse principal reste volontairement a 160 KiB. Le nouveau lazy utile porte les plafonds distribues a 454 KiB lazy et 716 KiB total; l initial reste a 263 KiB et la feuille CSS conserve son plafond de 59 KiB grace a la reutilisation des composants existants.

En 10.5.356, la selection des flux cash issus de Trip rejoint ce sous-module afin de separer l encaissement ou l avance integrale de la quote-part personnelle imputee au budget. Le domaine Analyse principal reste au plafond strict de 160 KiB; le sous-module pur et teste passe de 8 a 10 KiB et mesure 8.6 KiB. Le lazy distribue mesure 454.7 / 456 KiB et le total 716.8 / 718 KiB. Aucun nouveau composant CSS n est ajoute : les cartes reutilisent `analysis-stat` et une grille adaptative existante.

En 10.5.358, les signes du budget journalier, la protection des transactions Trip et le reste à attribuer réutilisent les pills et le rendu existants. Les plafonds ne bougent pas : Analyse 160 / 160 KiB, initial 263 / 263 KiB, lazy 454.1 / 456 KiB, total JS 717.1 / 718 KiB, CSS 58.7 / 59 KiB et gzip principal 75 / 110 KiB.

En 10.5.360, Sport remplace le programme A/B par un template Force / Hypertrophie sans charges codees en dur, avec metadonnees de type de semaine, type de progression et RIR cible. Alimentation ajoute la fondation recettes/batchs de cuisine : rendement, retention, poids final mesure prioritaire, portions et snapshots SQL. Les plafonds sont releves au palier minimal mesure : Sport 460 KiB, initial 266 KiB, lazy 457 KiB, total JS 723 KiB. CSS et gzip principal restent inchanges.

En 10.5.361, la fondation Cuisine devient un atelier complet et persistant, tandis que le profil Sport exploite les 17 indicateurs impédancemétriques disponibles dans une courbe interactive mono-échelle. Le domaine Sport mesure 464,8 / 465 KiB. Les plafonds distribués sont relevés au palier minimal mesuré : initial 268,3 / 269 KiB, lazy 461,3 / 462 KiB, total JS 729,6 / 730 KiB et CSS 61 / 61 KiB. Les mesures manquantes restent explicitement absentes; aucun calcul ne fabrique de donnée source.
...
En 10.5.367, le timer Sport reprend exactement la dernière charge validée pendant la séance et la navigation mobile affiche les quatre espaces dans une grille 2 x 2. Le helper legacy qui réappliquait des valeurs par défaut est supprimé. Les budgets restent sous les plafonds existants : Sport 477,3 / 478 KiB, initial 268,9 / 269 KiB, lazy 469,5 / 470 KiB, total JS 738,4 / 739 KiB et CSS 72,8 / 73 KiB.

En 10.5.368, les nouvelles regles de projection et de frais rejoignent le sous-module lazy `analysisCashBreakdown.js` (plafond 10 KiB), pas le coeur initial. Le calcul mort des revenus reels dans `_incomeSplit` et son wrapper sont supprimes : la tresorerie reelle dispose deja de sa selection dediee. Le plafond Analyse principal reste strictement 160 KiB et l initial 269 KiB; seuls les plafonds lazy et total JS passent au palier minimal de 471 et 740 KiB pour les nouvelles regles testees. Aucun CSS ajoute.
...
Le 25 septembre 2026, le pilote d'aide IA ajoute un client chargé à la demande, et la correction des amortissements ajoute un chargeur de données indépendant du domaine Patrimoine. Le build mesuré passe à environ 270.1 KiB initiaux, 476.3 KiB lazy, 746.4 KiB JS total et 73.4 KiB CSS. Les plafonds sont ajustés de façon bornée à 271/477/748/74 KiB respectivement ; les budgets des domaines legacy restent inchangés. La logique serveur et les tests ne font pas partie du bundle navigateur.

Le même jour, le premier module de comptabilité personnelle ajoute un domaine indépendant chargé à la demande (JS et CSS). Son code source est suivi séparément sous un plafond de 39 KiB. Le build mesure environ 270.6 KiB initiaux, 501.4 KiB lazy, 771.9 KiB JS total et 77.7 KiB CSS. Les plafonds lazy/total/CSS passent à 502/772/78 KiB pour cette nouvelle fonctionnalité ; le plafond initial reste à 271 KiB et les autres domaines restent inchangés.

L'évolution suivante consolide les devises avec les séries FX journalières et déduit les comptes depuis les catégories/sous-catégories. Les deux nouveaux modules purs/lazy sont inclus dans le groupe comptable (environ 52.8 / 53 KiB). Le build mesure environ 270.6 KiB initiaux, 511 KiB lazy, 781.6 KiB JS total et 77.8 KiB CSS ; seuls les plafonds lazy et total passent à 512/783 KiB. Le plafond initial 271 KiB et le CSS 78 KiB restent inchangés.

Le classement initial persistant, les sous-totaux signés, le bilan calculé et les indicateurs avec jauges natives portent le domaine comptable à environ 61.2 / 62 KiB. Le build mesure environ 270.6 KiB initiaux, 516.6 KiB lazy, 787.2 KiB JS total et 78.2 KiB CSS. Plafonds bornés à 517/788/79 KiB pour lazy/total/CSS ; initial inchangé à 271 KiB. Aucune bibliothèque graphique supplémentaire ; le calcul du bilan dupliqué dans la vue est retiré.

Le plan détaillé de 118 comptes, le rattachement budgétaire et les régularisations ajoutent trois modules purs au domaine comptable : catalogue, reconnaissance et indicateurs. Sources suivies à environ 88 / 89 KiB ; plafonds lazy/JS total bornés à 538/809 KiB, initial 271 KiB et CSS 79 KiB inchangés. Le catalogue reste lazy ; aucune dépendance graphique supplémentaire. L’ancien plan court et le rendu Mouvements sont supprimés.
