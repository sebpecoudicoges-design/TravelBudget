...
- Version à valider : `10.5.225`.
- Bilan : 7 parcours `ok`, 1 parcours `à revoir`.
- Retour à corriger : le changement de voyage ne semble pas fonctionner dans le parcours Réglages couvrant les versions `10.5.198 à 10.5.199` et `10.5.214 à 10.5.215`.
