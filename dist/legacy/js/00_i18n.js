...
(function () {
  ...
  const DICTS = {
    fr: {
      ...
      "nav.help": "Aide",
      "help.title": "Aide & FAQ",
      "help.subtitle": "Réponses courtes, exemples utiles et actions simples.",
      "help.search_label": "Rechercher dans la FAQ",
      "help.search_placeholder": "Ex : budget sourcé, wallet, à payer…",
      ...
      "help.guide.fx.body": "Automatique si possible. Sinon, tu peux saisir un taux simple.",
    ...
    en: {
      ...
      "nav.help": "Help",
      "help.title": "Help & FAQ",
      "help.subtitle": "Short answers, useful examples, and simple actions.",
      "help.search_label": "Search the FAQ",
      "help.search_placeholder": "e.g., reference budget, wallet, to pay…",
      ...
      "help.guide.fx.title": "Taux auto vs taux perso",
      "help.guide.fx.body": "Automatic when available. Otherwise you can set a simple custom rate.",
