  ...
  const payload = {
    ...
    transactions: state.transactions.map((tx) => {
      ...
      return {
        ...
        date_end: tx.dateEnd,
        budget_date_start: tx.budgetDateStart || tx.dateStart,
        budget_date_end: tx.budgetDateEnd || tx.dateEnd || tx.dateStart,
        pay_now: !!tx.payNow,
  ...
  await safeCall("Import backup", async () => {
    ...
    const txs = (normalized.transactions || []).map((t) => {
      ...
      wallet_id,
        ...
        date_end: t.date_end,
        budget_date_start: t.budget_date_start || t.date_start,
        budget_date_end: t.budget_date_end || t.date_end || t.date_start,
        pay_now: !!t.pay_now,
