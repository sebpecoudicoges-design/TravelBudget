...
describe('Sport profile rules bridge', () => {
  it('exposes the Sport profile rules module', () => {
    expect(bridge).toContain("import * as sportProfileRules from '../features/sport/sportProfileRules.js'");
    expect(bridge).toContain('window.Core.sportProfileRules = sportProfileRules');
  });
