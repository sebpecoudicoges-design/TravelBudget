...
describe('nutrition domain extraction contract', () => {
  ...
  it('keeps the extracted modules responsible for their domain surfaces', () => {
    ...
    expect(legacy).toContain('window.UI.createModal({');
    expect(legacy).toContain('id: "nutrition-cooking-modal"');
    expect(legacy).toContain('size: "xl"');
    ...
    expect(premiumTheme).toContain('.tb-nutrition-cook-modal-backdrop');
    expect(premiumTheme).toContain('.tb-nutrition-cook-workspace');
